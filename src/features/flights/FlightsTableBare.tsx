...
// export interface FlightsTableBareProps {
...
// export function FlightsTableBare({
//     flights,
//     deletingId = null,
//     onDelete,
// }: FlightsTableBareProps) {
...
//     // --- layout ---
//     const GRID_COLS =
//         "70px 110px 160px 160px 320px 110px 140px 120px 120px 140px 140px 140px 90px 190px 120px";
...
//                         <div style={{ ...cellHeader, borderRight: "none", justifyContent: "flex-end" }}>
//                             Actions
//                         </div>
//                     </div>
...
//                         return (
//                             <div key={f.id} style={{ ...rowStyleBase, background: bg }}>
